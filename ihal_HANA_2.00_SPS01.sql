...
SELECT 'ALL','indexserver.ini','table_placement','balance_by_execution_count',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_execution_count_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_execution_time',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_execution_time_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_memuse',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_memuse_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_part_id',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_part_id_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_partnum',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_partnum_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_rows',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_rows_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_classification',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_classification_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_size_hosted',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_size_hosted_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_subclassification',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_subclassification_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
...
SELECT 'ALL','global.ini','communication','ssl',' ','systempki','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2618451','SSL;encryption;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','system_replication_communication','enable_ssl',' ','on','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2618451','SSL;encryption;MDC',' ' from DUMMY UNION ALL
