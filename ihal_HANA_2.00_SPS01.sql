...
SELECT 'SYSREP','indexserver.ini','row_engine','keep_shared_memory_over_restart',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,12.009,2,2,'2522580','indexserver_crash; system_replication;RowStore;delta_data_shipping;takeover',' ' from DUMMY UNION ALL
...
SELECT 'ALL','global.ini','communication','ssl',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,12.019,2,2,'2547142','OOM;SSL;encryption',' ' from DUMMY UNION ALL
...
SELECT 'SYSREP','indexserver.ini','distribution','systemreplication_protocol_version',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2587258','hana_client;system_replication',' ' from DUMMY UNION ALL
...
SELECT 'ALL','global.ini','performance_analyzer','plan_trace_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2643064','indexserver_crash;trace;planviz;signal_11',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2600030','indexserver_crash;planviz',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','transaction','lock_wait_timeout',' ','5*<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2549013','lock_manager;deadlock',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','sql','cs_equi_cond_update_optimization_batch_size',' ','1000000','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2644935','LOB;wrong_result;consistency',' ' from DUMMY UNION ALL
SELECT 'ALL','nameserver.ini','statisticsserver','active',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2644242','statisticsserver;system_view;upgrade',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','statisticsserver','threadpool',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2584388','Memory_leak;',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','backup','data_backup_buffer_size',' ','1536','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2657261','backup;backint;performance',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','backup','parallel_data_backup_backint_channels',' ','3','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2657261','backup;backint;performance',' ' from DUMMY UNION ALL
SELECT 'SYSREP','global.ini','system_replication','check_secondary_active_status',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',10,-1,2,2,'2649721','system_replication;lock_manager;system_view',' ' from DUMMY UNION ALL
